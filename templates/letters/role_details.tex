...
Il Custode del Cimitero appartiene alla Fazione dei Popolani e ogni due notti può scegliere un giocatore morto di cui custodire la tomba. Per quella notte, se uno o più Negromanti tentano di risvegliare come Spettro il personaggio scelto dal Custode del Cimitero, il loro potere non ha alcun effetto. Inoltre, il Custode del cimitero scopre anche quanti altri personaggi hanno agito sul personaggio scelto (ma non quali).
{% endif %}


{% if player.role_name == "Sciamano" %}
...
Lo Sciamano è un mistico e appartiene alla Fazione dei Popolani, ma a causa del suo passato da Profanatore di Tombe ha aura nera. Ogni due notti, lo Sciamano può scegliere un personaggio morto e tormentarne lo spirito. Se il personaggio scelto è uno Spettro, e questi agisce, il suo potere non ha effetto.
{% endif %}
...
Il Messia è un mistico e appartiene alla Fazione dei Popolani. Ha un potere attivabile di notte, una sola volta in tutta la partita. Il Messia può scegliere di resuscitare un personaggio morto che tornerà in vita il giorno seguente, riacquistando i suoi poteri speciali. Il suo potere non funziona sugli Spettri.
{% endif %}
...
Lo Stalker appartiene (stranamente) alla Fazione dei Popolani ed ha un potere attivabile ogni due giorni. Lo Stalker sceglie un personaggio vivo da pedinare e scopre se ha agito durante la notte e, nel caso, su chi; non scopre però cosa ha fatto.
{% endif %}


{% if player.role_name == "Trasformista" %}
...
Il Trasformista appartiene alla Fazione dei Popolani, ma la sua vita nel mistero gli conferisce aura nera. Ha un potere attivabile di notte, una sola volta in tutta la partita. Il Trasformista può scegliere un personaggio morto. Se il personaggio scelto, nel momento in cui è morto, aveva un ruolo con un potere speciale attivabile una volta ogni una o due notti, ed apparteneva alla Fazione dei Popolani, il Trasformista lo scopre ed ottiene tale ruolo; altrimenti, il potere del Trasformista non ha effetto.
{% endif %}
...
Il Voyeur appartiene alla Fazione dei Popolani ed ha un potere attivabile ogni due notti. Il Voyeur può scegliere un personaggio vivo e spiare la sua casa. Scopre quali altri personaggi durante la notte hanno agito sul personaggio scelto, ma non cosa hanno fatto.
{% endif %}
...
I Lupi sono cattivi, brutti, hanno l'alito pesante e appartengono alla Fazione dei Lupi (ma dai). I Lupi si conoscono tra loro. Ogni notte i Lupi possono scegliere un personaggio vivo da uccidere. Se tutti i Lupi che decidono di usare il proprio potere scelgono lo stesso personaggio, questi muore. Se almeno due Lupi indicano personaggi diversi, il loro potere non ha alcun effetto.
Il potere dei Lupi ha effetto solo sui componenti della Fazione dei Popolani.
{% endif %}

{% if player.role_name == "Assassino" %}
...
L'Assassino appartiene alla Fazione dei Lupi, e conosce gli Avvocati, i Sequestratori, i Necrofili, i Rinnegati e gli eventuali altri Assassini. Ogni due notti dopo la prima, l'Assassino può scegliere un personaggio vivo e puntare il suo fucile di precisione verso casa sua. Uccide uno degli altri personaggi che hanno usato il proprio potere sul personaggio scelto dall'Assassino, selezionato in modo casuale.
{% endif %}

{% if player.role_name == "Avvocato" %}
La tua specialità è parlare per tre ore senza mai riprendere fiato e senza dire assolutamente nulla. In un villaggio di contadini che non hanno mai sentito pronunciare una parola più lunga di tre sillabe, questo ti rende pressoché onnipotente.

L'Avvocato non solo appartiene alla Fazione dei Lupi, ma è pure un avvocato. Ha un potere attivabile ogni due notti. L'Avvocato può scegliere un personaggio vivo e far approvare per esso una legge \emph{ad personam}. Se durante il giorno successivo l'assemblea delibera di uccidere tale personaggio, questi non muore. Grazie ai suoi agganci nella malavita, l'Avvocato conosce gli altri Avvocati, gli Assassini, i Necrofili, i Rinnegati ed i Sequestratori.
{% endif %}
...
Il Diavolo appartiene alla Fazione dei Lupi e conosce le Fattucchiere, gli Stregoni e gli eventuali altri Diavoli. Ogni notte il Diavolo può scegliere un personaggio vivo per leggere nella sua anima. Scopre il ruolo del personaggio scelto.
{% endif %}
...
La Fattucchiera è un mistico e appartiene alla Fazione dei Lupi; conosce i Diavoli, gli Stregoni e le eventuali altre Fattucchiere. Ogni notte la Fattucchiera può indicare un personaggio, vivo o morto, e stregarlo. Per quella notte l'aura di tale personaggio appare del colore opposto a quello effettivo.
{% endif %}
...
I suoi gusti particolari non piacevano agli abitanti del villaggio, e così il Necrofilo si è trasferito nella Fazione dei Lupi. Ha un potere speciale attivabile di notte: una sola volta durante l'arco della partita, il Necrofilo può scegliere un personaggio morto e fare... ehm... ecco... e prenderne il ruolo. Se il personaggio scelto appartiene alla Fazione dei Lupi, il Necrofilo lo scopre ed ottiene tale ruolo; altrimenti, il potere del Necrofilo non ha effetto. Conosce gli Assassini, gli Avvocati, i Rinnegati, i Sequestratori e gli eventuali altri Necrofili. Se il Necrofilo utilizza il suo... ehm, potere con successo, il bersaglio scopre (suo malgrado) l'identità del Necrofilo.</p>
...
Il Rinnegato appartiene alla Fazione dei Lupi, ma a causa del suo fascino irresistibile la sua aura è bianca. Non ha alcun potere speciale. Conosce gli Assassini, gli Avvocati, i Necrofili, i Sequestratori e gli eventuali altri Rinnegati.
{% endif %}
...
Il Sequestratore appartiene alla Fazione dei Lupi e conosce gli Assassini, gli Avvocati, i Necrofili, i Rinnegati e gli eventuali altri Sequestratori. Ogni notte, il Sequestratore può scegliere un personaggio vivo e rapirlo. Per quella notte, se il personaggio scelto agisce, il suo potere non ha effetto. Ai fini di tutti gli effetti di gioco, è come se quel personaggio non avesse agito affatto.
{% endif %}

{% if player.role_name == "Stregone" %}
...
Lo Stregone appartiene alla Fazione dei Lupi e conosce le Fattucchiere, i Diavoli e gli eventuali altri Stregoni. Ogni notte, lo Stregone può scegliere un personaggio vivo e lanciare un incantesimo sulla sua casa. Per quella notte, se un qualsiasi altro personaggio vivo agisce sul personaggio scelto dallo Stregone, il suo potere non ha effetto.
{% endif %}
...
Ogni notte, ciascun Negromante può scegliere un personaggio morto e selezionare un potere soprannaturale. Se tutti i Negromanti che decidono di usare il proprio potere speciale scelgono lo stesso personaggio e selezionano lo stesso potere soprannaturale, il personaggio scelto diventa uno Spettro e ottiene il potere selezionato. Da quel momento in poi, egli appartiene alla Fazione dei Negromanti. Gli viene comunicata l'identità dei Negromanti che lo hanno risvegliato come Spettro. Una volta che un potere soprannaturale viene assegnato ad uno Spettro (compreso il Fantasma), questo non può più essere scelto per i nuovi Spettri. Solo i personaggi appartenenti alla fazione dei Popolani possono essere risvegliati come Spettri. I Negromanti si conoscono fra loro.
{% endif %}
...
Il Fantasma appartiene alla Fazione dei Negromanti e ha aura nera. Non ha alcun potere speciale da vivo, ma se muore diventa immediatamente uno Spettro e ottiene uno dei poteri soprannaturali non ancora assegnati, scelto in modo casuale. Gli viene inoltre comunicata l'identità dei Negromanti, e ai Negromanti viceversa l'identità del Fantasma. Al Fantasma non possono venire assegnati i poteri soprannaturali della Corruzione e della Morte.
{% endif %}
...
Un personaggio può essere sotto il controllo di un solo Ipnotista per volta, e precisamente l'ultimo ad aver agito su di esso. L'Ipnotista conosce i Medium, gli Scrutatori e gli eventuali altri Ipnotisti. Ipnotisti.
{% endif %}
...
Il Medium è un mistico, appartiene alla Fazione dei Negromanti e ha aura bianca. Ogni notte, il Medium può scegliere un personaggio morto e contattarne lo spirito. Scopre il suo ruolo. Il Medium conosce gli Ipnotisti, gli Scrutatori e gli eventuali altri Medium.
{% endif %}


{% if player.role_name == "Scrutatore" %}
A volte per vincere non servono poteri mistici: basta una matita copiativa e una croce nel punto giusto. Nessuna scheda resta bianca a lungo nelle tue mani esperte. Gli ingenui abitanti del villaggio sono ben lontani dal sospettare i tuoi maneggi di democrazia creativa, che in ambienti meno sofisticati potrebbero essere chiamati brogli.

Lo Scrutatore appartiene alla Fazione dei Negromanti e ha aura bianca. Ogni due notti, lo Scrutatore può scegliere  un personaggio vivo e taroccare i voti diretti a lui. Il giorno seguente, al momento della pubblicazione dei voti, tutti i voti diretti al personaggio scelto saranno invece assegnati al personaggio votato dallo Scrutatore. Lo Scrutatore conosce gli Ipnotisti, i Medium e gli eventuali altri Scrutatori.
{% endif %}
